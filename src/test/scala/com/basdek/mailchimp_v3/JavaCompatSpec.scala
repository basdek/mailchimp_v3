...
import com.basdek.mailchimp_v3.dto.{MailChimpInterestCategory, MailChimpList, MailChimpList_Contact, MailChimpMember}
...
class JavaCompatSpec extends FlatSpec with Matchers {
  ...
  "MailChimpInterestCategory" should "be instantiable in Java" in {
    val test = ifj.instantiateMailChimpInterestCategory()
    test shouldBe an [MailChimpInterestCategory]
  }
